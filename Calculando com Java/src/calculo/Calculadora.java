...
public class Calculadora {
	public static void main(String[] args) {
		...
		System.out.println("Insira 1 para somar;");
		System.out.println("Insira 2 para subtrair;");
		System.out.println("Insira 3 para multiplicar;");
		System.out.println("Insira 4 para dividir.");
